...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2023 at 03:17 PM
...
(1, 'Goo', 'admin2@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 0, 2147483647),
(2, 'Chu Minh Nam', 'admin@gmail.com', '206dcce3f82cf8981d316e7900dc8e06', 1, 2147483647);
...
(25, 'Áo khoác nam', 'Áo khoác mùa đông dành cho nam', 7, 1, '0000-00-00 00:00:00');
...
CREATE TABLE `order` (
  ...
  `size` varchar(5) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'M',
...
INSERT INTO `order` (`id`, `transaction_id`, `product_id`, `qty`, `amount`, `size`, `status`) VALUES
(1, 3, 12, 1, '360000.00', 'M', 0),
(3, 4, 7, 1, '350000.00', 'XL', 0),
(12, 9, 4, 1, '200000.00', 'M', 0),
(13, 10, 17, 1, '450000.00', 'M', 0),
(6, 5, 23, 1, '370000.00', 'M', 0),
(7, 6, 28, 1, '169000.00', 'M', 0),
(8, 6, 25, 1, '300000.00', 'M', 0),
(11, 8, 10, 1, '69000.00', 'M', 0),
(10, 7, 11, 1, '70000.00', 'M', 0),
(14, 11, 25, 1, '300000.00', 'M', 0),
(15, 12, 28, 1, '169000.00', 'M', 0),
(16, 13, 28, 1, '169000.00', 'M', 0),
(17, 14, 29, 2, '360000.00', 'M', 0),
(18, 14, 28, 3, '507000.00', 'M', 0),
(19, 15, 23, 1, '370000.00', 'M', 0),
(20, 16, 7, 1, '350000.00', 'M', 0),
(21, 17, 23, 1, '370000.00', 'M', 0),
(22, 18, 23, 1, '370000.00', 'M', 0),
(23, 19, 23, 1, '370000.00', 'XL', 0),
(24, 20, 7, 1, '350000.00', 'XXL', 0),
(25, 21, 4, 1, '200000.00', 'XXL', 0),
(26, 21, 29, 1, '180000.00', 'L', 0),
(27, 22, 29, 1, '180000.00', 'XXL', 0),
(28, 23, 23, 1, '370000.00', 'XXL', 0);
...
(4, 18, 'phối ren', '<p>ẢO KIỂU H&Agrave;N QUỐC V0040&nbsp;&nbsp;tay lỡ l&agrave; gu chủ yếu cho những ng&agrave;y thu. Nếu như h&egrave; bạn c&oacute; thể t&aacute;o bạo diện một chiếc sơ mi kh&ocirc;ng tay hay kiểu cổ ph&oacute;ng kho&aacute;ng cho thời trang c&ocirc;ng sở th&igrave; sang thu sẽ k&iacute;n đ&aacute;o hơn nhiều với kiểu sơ mi tay lỡ hoặc d&aacute;ng d&agrave;i tay đều ph&ugrave; hợp.</p>\r\n\r\n<p>Những mẫu sơ mi thiết kế tay lỡ vẫn sử dụng gam đơn hoặc họa tiết nếu muốn mix ph&ugrave; hợp c&ugrave;ng quần t&acirc;y, jean hay ch&acirc;n v&aacute;y ăn &yacute;.</p>\r\n\r\n<p>ẢO KIỂU&nbsp;<a href=\"https://www.sendo.vn/han-quoc.htm\">H&Agrave;N QUỐC</a>&nbsp;V0040 với c&aacute;c th&ocirc;ng tin như sau:</p>\r\n\r\n<p>+ Mẫu m&atilde;: như h&igrave;nh;</p>\r\n\r\n<p>+ Xuất xứ: Việt Nam</p>\r\n\r\n<p>+ M&agrave;u sắc: Hồng, xanh, trắng, t&iacute;m</p>\r\n\r\n<p>+ Kiểu d&aacute;ng: tay lỡ, vạt ngang, cổ tr&ograve;n k&egrave;m d&acirc;y chuyền phụ kiện;</p>\r\n\r\n<p>+ Size: S, M, L, XL</p>\r\n', '280000.00', 80000, 'hang-nhap-cao-cap-so-mi-nu-phoi-ren-sm115-1m4G3-HuHbF8_simg_d0daf0_800x1200_max.jpg', '[\"hang-nhap-cao-cap-so-mi-nu-phoi-ren-sm115-1m4G3-q1bUZr_simg_d0daf0_800x1200_max.jpg\"]', 17, 7, 18, 4, 1493983674),
...
(23, 21, 'COMBO ĐẦM REN MÙA XUÂN', '<p><strong>TH&Ocirc;NG TIN SẢN PHẨM&nbsp;</strong></p>\r\n\r\n<p>- Chất liệu : REN</p>\r\n\r\n<p>- Năm sản xuất : 2016</p>\r\n\r\n<p>- Xuất xứ : Việt nam&nbsp;</p>\r\n\r\n<p>- M&agrave;u sắc :đỏ</p>\r\n\r\n<p>- K&iacute;ch thước : Freesize từ 43-55k... size M từ 13-17. size L từ 17-25</p>\r\n', '450000.00', 80000, 'combo-dam-ren-mua-xuan-cho-me-va-be-th08602-gs210-1m4G3-g4rMfx.jpg', '[\"combo-dam-ren-mua-xuan-cho-me-va-be-th08602-gs210-1m4G3-kwPno1.jpg\"]', 20, 7, 22, 5, 1493983674),
...
(12, 1, 6, 'Nguyen An', 'khachhang1@gmail.com', '01201212222', 'Thủy Nguyên - Hải Phòng', 'SHIP TO', '169000.00', '', 1494407353),
(13, 0, 0, 'Chu Minh Nam', 'chuminhnamma@gmail.com', '0379962045', 'Hà Nội', 'Đặt hàng trước T2', '169000.00', '', 1676125169),
(14, 0, 6, 'Nguyen An', 'khachhang1@gmail.com', '01201212222', 'Thủy Nguyên - Hải Phòng', 'Giao hàng cho tôi ở công ti', '867000.00', '', 1676125405),
(15, 0, 0, 'Nam', 'chuminhnam@gmail.com', '0379962045', 'Hà Nội', 'Giao hàng nhanh nhé bạn', '370000.00', '', 1676268803),
(16, 0, 0, 'Nam Minh', 'nam@gmail.com', '0999888999', 'Hà Nội', 'Ok', '350000.00', '', 1676268899),
(17, 0, 0, 'Nam', 'nam@gmail.com', '0555666777', 'Hà Nam', 'Ok', '370000.00', '', 1676270008),
(18, 0, 0, 'Chu Minh Nam', 'namchuminh@gmail.com', '0379962045', 'Hà Nội', 'Giao hàng nhanh nhé', '370000.00', '', 1676270106),
(19, 0, 0, 'Nam Hùng', 'namhung@gmail.com', '0399620444', 'Hà Giang', 'Giao hang nhanh nhe', '370000.00', '', 1676270140),
(20, 0, 0, 'Nam Hưng', 'namhung@gmail.com', '0599888666', 'Hà Nam', 'Ok', '350000.00', '', 1676270330),
(21, 0, 0, 'Nam Tiến Hoàng', 'namtienhoang@gmail.com', '0699888666', 'Hà Nội', 'ok', '380000.00', '', 1676270415),
(22, 0, 0, 'Hà Cần', 'hacan@gmail.com', '0899666333', 'Hà Giang', 'Ok', '180000.00', '', 1676270798),
(23, 0, 0, 'Hoàng', 'hoang@gmail.com', '0655326589', 'Hà Nội', 'Ok cảm ơn', '370000.00', '', 1676272429);
...
(6, 'Nguyen An', 'khachhang1@gmail.com', '206dcce3f82cf8981d316e7900dc8e06', '01201212222', 'Thủy Nguyên - Hải Phòng', 2147483647),
