		...
		<div class="panel panel-info " style="margin-bottom: 15px">
		  ...
		  <div class="panel-body">
		  	...
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<input type="hidden" value="<?php echo $product->id; ?>" class="pid">
		  		<a href="<?php echo base_url('cart/add/'.$product->id.'/M/'); ?>" class="btn btn-info addcardproduct"> Thêm vào giỏ hàng</a>
		  	</div>
...
<script type="text/javascript">
	var base_url =  window.location.origin == "http://localhost" ? window.location.origin + "/webshop" : window.location.origin
	$('select').on('change', function() {
		var id = $('.pid').val()
		var size = this.value
		$(".addcardproduct").attr("href", base_url + '/cart/add/'+id+'/'+size+'/')
	});
</script>